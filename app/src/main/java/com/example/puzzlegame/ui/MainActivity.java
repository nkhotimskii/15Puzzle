...
public class MainActivity extends AppCompatActivity implements PuzzleView.Listener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_easy) {
            toolbar.post(() -> viewModel.selectDifficulty(Difficulty.EASY));
            return true;
        } else if (id == R.id.menu_normal) {
            toolbar.post(() -> viewModel.selectDifficulty(Difficulty.NORMAL));
            return true;
        } else if (id == R.id.menu_hard) {
            toolbar.post(() -> viewModel.selectDifficulty(Difficulty.HARD));
            return true;
        } else if (id == R.id.theme_yellow_green) {
            toolbar.post(() -> viewModel.setTileTheme(TileTheme.YELLOW_GREEN));
            return true;
        } else if (id == R.id.theme_orange_red) {
            toolbar.post(() -> viewModel.setTileTheme(TileTheme.ORANGE_RED));
            return true;
        } else if (id == R.id.theme_rose_purple) {
            toolbar.post(() -> viewModel.setTileTheme(TileTheme.ROSE_PURPLE));
            return true;
